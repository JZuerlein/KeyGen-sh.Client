...
namespace KeyGenClient.UnitTest
{
    public class ValidateKeyResponseTest
    {
        ...
        public void Serialize_CreatesProperJson_WhenValuesAreProvided()
        {
            ...
            var actual = JsonSerializer.Deserialize<KeyGenClient.Models.License>(json);
        ...
        {
            var fixture = new Fixture();
            var response = new KeyGenClient.Models.License();

            response.meta.detail = "Test";

            var actual = JsonSerializer.Serialize<KeyGenClient.Models.License>(response);
